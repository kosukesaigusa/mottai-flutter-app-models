...
class _$AppUserCollectionReference extends _$AppUserQuery
  ...
  factory _$AppUserCollectionReference([FirebaseFirestore? firestore]) {
    ...
    return _$AppUserCollectionReference._(
      firestore.collection('appUsers').withConverter(
...
class _$AppUserDocumentReference
  ...
  Future<void> update({
    ...
    final json = {
      if (appUserId != _sentinel) "appUserId": appUserId as String,
...
class _$AppUserQuery extends QueryReference<AppUserQuerySnapshot>
  ...
  AppUserQuery orderByAppUserId({
    ...
    var query = reference.orderBy('appUserId', descending: false);
...
class _$AttendingChatRoomDocumentReference
  ...
  Future<void> update({
    ...
    final json = {
      if (chatRoomId != _sentinel) "chatRoomId": chatRoomId as String,
...
abstract class AttendingChatRoomQuery
  ...
  AttendingChatRoomQuery whereChatRoomId({
    String? isEqualTo,
    String? isNotEqualTo,
    String? isLessThan,
    String? isLessThanOrEqualTo,
  ...
  AttendingChatRoomQuery whereUpdatedAt({
    String? isEqualTo,
    String? isNotEqualTo,
    String? isLessThan,
    String? isLessThanOrEqualTo,
  ...
  AttendingChatRoomQuery orderByChatRoomId({
    bool descending = false,
    String startAt,
    String startAfter,
    String endAt,
  ...
  AttendingChatRoomQuery orderByUpdatedAt({
    bool descending = false,
    String? startAt,
    String? startAfter,
    String? endAt,
...
class _$AttendingChatRoomQuery
  ...
  AttendingChatRoomQuery orderByChatRoomId({
    ...
    var query = reference.orderBy('chatRoomId', descending: false);
